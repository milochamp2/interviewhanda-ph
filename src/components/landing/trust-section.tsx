  ...
  return (
    <section className="relative px-4 py-20 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-2xl text-center">
        <FadeUp>
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-100 to-indigo-50 pulse-glow dark:from-indigo-900/40 dark:to-indigo-800/20">
        ...
        <FadeUp delay={0.1}>
          ...
          <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">{t.subtitle}</p>
        </FadeUp>
        ...
        <StaggerGroup className="flex flex-wrap items-center justify-center gap-3">
          {[
            ...
            <StaggerItem key={m.label}>
              <motion.div
                whileHover={{ y: -2 }}
                className="glow-card flex items-center gap-2.5 rounded-xl border border-gray-100/80 bg-white px-5 py-3 text-sm font-medium text-gray-700 dark:border-white/10 dark:bg-white/5 dark:text-gray-300"
              >
                <m.icon className="h-4 w-4 text-indigo-400 dark:text-indigo-500" />
                {m.label}
              </motion.div>
            </StaggerItem>
          ))}
